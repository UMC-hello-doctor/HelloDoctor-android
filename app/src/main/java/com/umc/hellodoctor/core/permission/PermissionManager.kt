...
class PermissionManager(
    ...
    fun hasLocationPermission(): Boolean =
        PermissionConstants.LOCATION_PERMISSIONS.any { hasPermission(it) }

    fun hasCameraPermission(): Boolean =
        PermissionConstants.CAMERA_PERMISSIONS.any { hasPermission(it) }

    fun hasNotificationPermission(): Boolean =
        PermissionConstants.NOTIFICATION_PERMISSIONS.all { hasPermission(it) }
